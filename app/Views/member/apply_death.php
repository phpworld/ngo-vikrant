    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-plus-square me-2 text-danger"></i>मृत्यु सहायता आवेदन
            </h1>
            <p class="text-muted mb-0">मृत्यु सहायता के लिए आवेदन फॉर्म भरें</p>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-gradient-danger text-white">
                <h5 class="mb-0">
                    <i class="fas fa-form me-2"></i>मृत्यु सहायता आवेदन फॉर्म
                </h5>
            </div>
            <div class="card-body">
                ...
                <form action="/member/apply-death-help" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control <?= $validation->hasError('application_amount') ? 'is-invalid' : '' ?>" 
                                       name="application_amount" value="<?= old('application_amount') ?>" min="1" max="25000" required>
                                <div class="form-text">अधिकतम राशि: ₹25,000</div>
                                <div class="invalid-feedback">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">मृत्यु प्रमाण पत्र <span class="text-danger">*</span></label>
                                <input type="file" class="form-control" name="death_certificate" accept=".jpg,.jpeg,.png,.pdf" required>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <ul class="list-unstyled small">
                        <li><i class="fas fa-check text-success me-2"></i>मृत्यु के 30 दिन के अंदर आवेदन करना होगा</li>
                        <li><i class="fas fa-check text-success me-2"></i>पारिवारिक आय ₹2,00,000 प्रति वर्ष से कम होनी चाहिए</li>
                        <li><i class="fas fa-check text-success me-2"></i>मृत्यु प्रमाण पत्र अनिवार्य है</li>
                    </ul>
                </div>
                <div class="mb-3">
                    <h6 class="text-primary">आवश्यक दस्तावेज:</h6>
                    <ul class="list-unstyled small">
                        <li><i class="fas fa-file text-danger me-2"></i>मृत्यु प्रमाण पत्र (अनिवार्य)</li>
                ...
                <div class="alert alert-warning">
                    <small>
                        ...
                        मृत्यु सहायता केवल एक बार ही प्रदान की जाती है। कृपया सभी जानकारी सही भरें।
                    </small>
                </div>
            </div>
        </div>
