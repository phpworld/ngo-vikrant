        ...
        <a href="/admin/users" class="text-decoration-none">
            <div class="card border-0 shadow-sm quick-action-card">
                <div class="card-body text-center py-4">
                    ...
                    <p class="text-muted mb-0 small">सभी उपयोगकर्ताओं को देखें और प्रबंधित करें</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="/admin/settings" class="text-decoration-none">
            <div class="card border-0 shadow-sm quick-action-card">
                <div class="card-body text-center py-4">
                    ...
                    <p class="text-muted mb-0 small">सिस्टम सेटिंग्स को कॉन्फ़िगर करें</p>
                </div>
            </div>
        </a>
    </div>
...
<?= $this->endSection() ?>
        <div class="card">
            <div class="card-body text-center">
                <h5 class="card-title">शिक्षा सहायता</h5>
                <h2 class="text-success"><?= $educationApplications ?></h2>
                <p class="text-muted">कुल आवेदन</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="fas fa-file-alt me-2"></i>हाल के आवेदन</h5>
            </div>
            <div class="card-body">
                <?php if (!empty($recentApplications)): ?>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php foreach (array_slice($recentApplications, 0, 10) as $application): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            $types = [
                                                'vivah_help' => 'विवाह सहायता',
                                                'death_help' => 'मृत्यु सहायता',
                                                'education_help' => 'शिक्षा सहायता'
                                            ];
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge bg-<?= $statusClass[$application['status']] ?? 'secondary' ?>">
                                                <?= $statusText[$application['status']] ?? $application['status'] ?>
                                            </span>
                                        </td>
                                        <td><?= date('d/m/Y', strtotime($application['created_at'])) ?></td>
                                        <td>
                                            <a href="/admin/applications?filter=all" class="btn btn-sm btn-outline-primary">
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted">कोई आवेदन नहीं मिला</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-secondary text-white">
                <h5 class="mb-0"><i class="fas fa-bolt me-2"></i>त्वरित कार्य</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2">
                        <a href="/admin/applications?filter=pending" class="btn btn-outline-warning w-100">
                            <i class="fas fa-clock me-2"></i>लंबित आवेदन
                        </a>
                    </div>
                    <div class="col-md-3 mb-2">
